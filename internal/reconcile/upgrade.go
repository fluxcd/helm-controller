...
func (r *Upgrade) failure(req *Request, buffer *action.LogBuffer, err error) {
	...
	// Condition summary.
	r.eventRecorder.AnnotatedEventf(req.Object, eventMeta(req.Chart.Metadata.Version), corev1.EventTypeWarning, v2.UpgradeFailedReason, eventMessageWithLog(msg, buffer))
}
...
func (r *Upgrade) success(req *Request) {
	...
	// Record event.
	r.eventRecorder.AnnotatedEventf(req.Object, eventMeta(cur.ChartVersion), corev1.EventTypeNormal, v2.UpgradeSucceededReason, msg)
}
