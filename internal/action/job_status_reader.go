...
// Copied from (yes, they copied from us first, now we're copying from them. Hopefully for not long):
// https://github.com/helm/helm/blob/75880fa498b511cdc4d31dd8752b4937cfb15cf9/internal/statusreaders/job_status_reader.go
