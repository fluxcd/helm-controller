...
// ErrReleaseDigest.
func VerifyStorage(config *helmaction.Configuration, obj *helmv2.HelmRelease) (*helmrelease.Release, error) {
...
func VerifyRelease(rls *helmrelease.Release, obj *helmv2.HelmRelease, chrt *helmchart.Metadata, vals helmchartutil.Values) error {
	if rls == nil {
