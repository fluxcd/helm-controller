...
// loadHelmChart attempts to download the advertised artifact of the
// given v1beta1.HelmChart, loads it into a chart.Chart, and removes
// the downloaded artifact. It returns the loaded chart.Chart on success,
// or an error.
